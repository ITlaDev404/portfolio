...
const Header: React.FC = () => {
  ...
  return (
    <header className={` sticky top-0 z-50 transition-colors duration-300 ${isScrolled ? "bg-componentColor shadow-lg": "bg-portfolioBackground2"} duration-300  text-protfolioText p-4 text-center text-2xl font-bold  border-borderColor border-b-1`} >
      <button className="bg-componentColor2 hover:bg-componentColor3  active:bg-componentColor border-solid border-borderColor text-portfolioText text-center bg-center text-2xl  grid-cols-1 mr-4 px-4 py-2 rounded hover:shadow-lg  ">
        Navigation
      </button>
      <button
